 ...
 * { android.graphics.VectorDrawableCompat} to create an animated drawable.
 * <p>
 * AnimatedVectorDrawableCompat are normally defined as 3 separate XML files.
 * </p>
 * <p>
 * First is the XML file for { android.graphics.VectorDrawableCompat}. Note that we
    ...
    public Drawable mutate() {
        if (!mMutated && super.mutate() == this) {
            mAnimatedVectorState =
                    new AnimatedVectorDrawableCompatState(
                            null, mAnimatedVectorState, mCallback,
                            null
                    );
            mMutated = true;
        }
            ...
            if (eventType == XmlPullParser.START_TAG) {
                ...
                if (ANIMATED_VECTOR.equals(tagName)) {
                    ...
                    int drawableRes = a.getResourceId(
                            R.styleable.AnimatedVectorDrawable_drawable,
                            0
                    );
                    if (DBG_ANIMATION_VECTOR_DRAWABLE) {
