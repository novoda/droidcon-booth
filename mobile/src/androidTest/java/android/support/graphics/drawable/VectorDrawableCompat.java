...
public class VectorDrawableCompat extends Drawable {
     ...
     */
    @Nullable
    public static VectorDrawableCompat create(@NonNull Resources res, int resId,
    ...
    private void updateStateFromTypedArray(TypedArray a) throws XmlPullParserException {
        ...
        final float alphaInFloat = a.getFloat(
                R.styleable.VectorDrawable_alpha,
    ...
    private void printGroupTree(VGroup currentGroup, int level) {
        ...
        Log.v(
                LOGTAG, indent + "current group is :" + currentGroup.getGroupName()
    ...
    private static class VectorDrawableState extends ConstantState {
        ...
        public void createCachedBitmapIfNeeded(Rect bounds) {
            if (mCachedBitmap == null || !canReuseBitmap(
                    bounds.width(),
                    bounds.height()
            )) {
        ...
        private void drawGroupTree(VGroup currentGroup, Matrix currentMatrix,
            ...
            for (int i = 0; i < currentGroup.mChildren.size(); i++) {
                ...
                if (child instanceof VGroup) {
                    ...
                    drawGroupTree(
                            childGroup, currentGroup.mStackedMatrix,
                            canvas, w, h, filter
                    );
    ...
    private static class VFullPath extends VPath {
        ...
        private void updateStateFromTypedArray(TypedArray a) {
            ...
            mFillAlpha = a.getFloat(
                    R.styleable.VectorDrawablePath_fillAlpha,
                    mFillAlpha
            );
            ...
            mStrokeAlpha = a.getFloat(
                    R.styleable.VectorDrawablePath_strokeAlpha,
                    mStrokeAlpha
            );
            mStrokeWidth = a.getFloat(
                    R.styleable.VectorDrawablePath_strokeWidth,
                    mStrokeWidth
            );
            mTrimPathEnd = a.getFloat(
                    R.styleable.VectorDrawablePath_trimPathEnd,
                    mTrimPathEnd
            );
