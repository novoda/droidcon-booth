...
public final class Version {
  ...
  public ECBlocks getECBlocksForLevel(com.google.zxing.qrcode.decoder.ErrorCorrectionLevel ecLevel) {
  ...
  static Version decodeVersionInformation(int versionBits) {
    ...
    for (int i = 0; i < VERSION_DECODE_INFO.length; i++) {
      ...
      // we have seen so far
      int bitsDifference = com.google.zxing.qrcode.decoder.FormatInformation.numBitsDiffering(versionBits, targetVersion);
